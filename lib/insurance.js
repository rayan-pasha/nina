 ...
 *
 * `mock` names a scene in components/GuidanceMock.js rather than an image
 * file: these are drawn, so they stay sharp at any card width and don't need
 * a screenshot of a product that changes.
 */

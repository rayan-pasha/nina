 ...
 * non-interactive text rather than links that dead-end. Give an entry an href
 * and it becomes a link with no other change. A string that matches a key in
 * lib/links.js (e.g. "youtube") resolves to that outbound URL.
 */

 ...
 *
 * `image` is the article's cover, downloaded from the published version on
 * agenq.com and re-encoded to webp at 1200px wide — the originals were PNGs
 * of 1.3–1.9MB each, which is more than a blog index should carry.
 *
...
export const POSTS = [
  {
    ...
    image: "/blog/canada-ai-adoption-all-in-2026.webp",
    imageAlt: "Canada’s Top 100 AI Startups — ALL IN 2026",
    body: [
      {
        type: "note",
        title: "In short",
...

  {
    ...
    image: "/blog/insurance-saas-time-to-value.webp",
    imageAlt: "How insurance SaaS reduces time to value",
    subhead:
...

  {
    ...
    image: "/blog/ai-guided-workflows-for-insurance-software.webp",
    imageAlt: "Insurance software onboarding case study",
...

  {
    ...
    image: "/blog/best-ai-saas-automation-platform.webp",
    imageAlt: "The AgenQ Dashboard V2 interface",
